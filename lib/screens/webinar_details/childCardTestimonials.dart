...
class _childCardTestimonialsState extends State<childCardTestimonials> {
  ...
  void initState() {
    ...
    // print('Length For respTestimonials is : $lengthTestimonials');
    print('Init formtestimonials is called length is : ${respTestimonials.length}');
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: respTestimonials.length.toString() == '0'
          ? Container(
              height: 20.0.w,
              // color: Colors.teal,
              child: Center(
                child: Text(
                  'No testimoials available for this webinar',
                  style: TextStyle(
                    fontSize: 10.0.sp,
