...
//
//     final webList = webListFromJson(jsonString);

import 'dart:convert';

WebList webListFromJson(String str) => WebList.fromJson(json.decode(str));

String webListToJson(WebList data) => json.encode(data.toJson());
...
class WebList {
  ...
  factory WebList.fromJson(Map<String, dynamic> json) => WebList(
